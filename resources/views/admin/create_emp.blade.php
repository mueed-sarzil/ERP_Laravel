...
<div style="margin-left:25%;padding:1px 16px;height:100px;">
    <div><h1 style="color: blue;" align="center"><b><i>Employee Management System</i></b></h1>
    <h3 style="color: blue;">Welcome To <a href="{{route('admin.index')}}">{{ Session::get('uname')}}</a></h3>
</div><hr>
<h1 align="center">New_Employee</h1>
    <form method="post" enctype="multipart/form-data">
      {{@csrf_field()}}
  <label>
    <p class="label-txt">Enter Employee Name</p>
  ...
  <label>
    <p class="label-txt">Enter Employee Mail</p>
  ...
  <label>
    <p class="label-txt">Enter Employee Phone</p>
  ...
  <label>
    <p class="label-txt">Enter Employee Job-Title</p>
  ...
  <label>
    <p class="label-txt">Enter Employee UserName</p>
  ...
  <label>
    <p class="label-txt">Enter Employee Password</p>
  ...
  <label>
    <p class="label-txt">Employee  Picture</p>
