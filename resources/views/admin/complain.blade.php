...
<h1 align="center">Leave</h1>
    <form method="post">
        {{@csrf_field()}}
  <label>
    <p class="label-txt">Enter your name Name</p>
  ...
  <label>
    <p class="label-txt">Enter Leave Reason</p>
  ...
  <label>
    <p class="label-txt">Enter Emergancy Contact</p>
    <input type="text" name="floor" class="input" required="">
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
  <label>
    <p class="label-txt">Enter EMployee Department</p>
    <input type="text" name="dept" class="input" required="">
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
  <label>
    <p class="label-txt">Enter Leave From Date</p>
    <input type="datetime-local" name="idate" class="input" required="">
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
  <label>
    <p class="label-txt">Enter Leave To Date</p>
    <input type="datetime-local" name="rdate" class="input" required="">
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
